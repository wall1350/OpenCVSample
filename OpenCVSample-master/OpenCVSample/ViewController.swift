...
//        imageView.image = OpenCVWrapper.cannyEdgeImage(imageView.image)
        imageView.image = OpenCVWrapper.findTheCenterPoint(imageView.image)
    }
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        guard let takenImage = info[UIImagePickerController.InfoKey.originalImage.rawValue] as? UIImage else {
